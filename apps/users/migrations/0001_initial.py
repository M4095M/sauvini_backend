    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('exp_school_years', models.IntegerField(blank=True, null=True)),
                ('exp_off_school', models.BooleanField(default=False)),
                ('exp_online', models.BooleanField(default=False)),
                ('cv_path', models.URLField(max_length=500)),
                ('profile_picture_path', models.URLField(blank=True, max_length=500, null=True)),
